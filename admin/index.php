...
div#topbox a, div#topbox a:visited
{
	color:#FFFFFF;
...
$(document).ready(function(){
	$('select.life').removeAttr('disabled');
	
	$('select.life').change(function(){
		var dataString = "id=" + $(this).attr('id') + "&v=" + $(this).val();
		var id = $(this).attr('id');	
		$.ajax({
			type:'POST',
			url:'/admin/includes/php/AJAX_lifeupdate.php',
			data: dataString,
			beforeSend: function(){
				$('span#loader_' + id).show();
			},
			complete: function(){
				$('span#loader_' + id).hide();
			},
			error: function(){
				alert("Not able to update system, please try again.");
			},
			success: function(){
			}
		});
...
<div id="frame">
		...
		?>
         ...
         <img src="http://hvzatfsu.com/images/banners/banner3_w900xh150.png" />
...
<div id="navblock">
   ...
   <div id="reportkill2">
    ...
    <!-- end reportkill2-->
		...
		<form action="http://hvzatfsu.com/search.php" method="get" id="searchform">
